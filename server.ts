...
let residentsStore: any[] = [
  {
    ...
    name: 'Soham Gonbhare',
    building: 'Pravesh Residency (Tower A)',
    wing: 'Tower A',
    flat: 'A-702',
    flatNumber: 'A-702',
    ...
    telegramChatId: process.env.TELEGRAM_DEFAULT_CHAT_ID || '123456789',
    telegramUsername: '@soham_g',
    status: 'active',
  ...
  },
  {
    ...
    email: 'rajesh.sharma@pravesh.in',
    telegramChatId: '987654321',
    telegramUsername: '@rajesh_s',
    status: 'active',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    name: 'Priya Patel',
    building: 'Pravesh Residency (Tower B)',
    wing: 'Tower B',
    flat: 'B-501',
    flatNumber: 'B-501',
    phone: '+91 98111 22334',
    mobile: '+91 98111 22334',
    email: 'priya.patel@pravesh.in',
  ...
  },
  {
    ...
    mobile: '+91 98999 88776',
    email: 'amitabh.verma@pravesh.in',
    telegramChatId: '765432109',
    telegramUsername: '@amitabh_v',
    status: 'active',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    building: 'Pravesh Residency (Tower C)',
    wing: 'Tower C',
    flat: 'C-103',
    flatNumber: 'C-103',
    phone: '+91 97654 32109',
    mobile: '+91 97654 32109',
    email: 'sunita.deshmukh@pravesh.in',
    telegramChatId: '654321098',
    telegramUsername: '@sunita_d',
    status: 'active',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    email: 'vikram.malhotra@pravesh.in',
    telegramChatId: '543210987',
    telegramUsername: '@vikram_m',
    status: 'active',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    name: 'Ananya Iyer',
    building: 'Pravesh Residency (Tower D)',
    wing: 'Tower D',
    flat: 'D-401',
    flatNumber: 'D-401',
    phone: '+91 98450 67890',
    mobile: '+91 98450 67890',
    email: 'ananya.iyer@pravesh.in',
    telegramChatId: '432109876',
    telegramUsername: '@ananya_i',
    status: 'active',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
...
let buildingsStore: any[] = [
  { id: 'bldg-1', name: 'Pravesh Residency - Tower A', code: 'TOWER_A', totalUnits: 32, occupiedUnits: 28, floors: 8 },
  { id: 'bldg-2', name: 'Pravesh Residency - Tower B', code: 'TOWER_B', totalUnits: 32, occupiedUnits: 30, floors: 8 },
  { id: 'bldg-3', name: 'Pravesh Residency - Tower C', code: 'TOWER_C', totalUnits: 32, occupiedUnits: 26, floors: 8 },
  { id: 'bldg-4', name: 'Pravesh Residency - Tower D', code: 'TOWER_D', totalUnits: 32, occupiedUnits: 29, floors: 8 },
];
